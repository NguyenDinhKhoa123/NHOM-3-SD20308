...
<div class="p-5 mb-4 bg-light rounded-3 shadow-sm border">
    <div class="container-fluid py-5 text-center">
        ...
        <div class="mt-4">
            <a href="drinks" class="btn btn-success btn-lg px-5 shadow-sm">Xem thực đơn ngay</a>

            <%-- Sau khi thêm taglib ở đầu trang, thẻ này sẽ hoạt động chính xác --%>
            <c:if test="${empty sessionScope.user}">
                <a href="login" class="btn btn-outline-primary btn-lg px-5 ms-2 shadow-sm">Đăng nhập</a>
            </c:if>
        </div>
    </div>
</div>
...
<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
  <div class="col d-flex align-items-start">
    <div class="icon-square text-bg-light d-inline-flex align-items-center justify-content-center fs-2 flex-shrink-0 me-3">

    </div>
    <div>
      <h3 class="fs-4 fw-bold">Chất lượng hàng đầu</h3>
  ...
  <div class="col d-flex align-items-start">
    ...
    <div>
      <h3 class="fs-4 fw-bold">Phục vụ nhanh chóng</h3>
  ...
  <div class="col d-flex align-items-start">
    ...
    <div>
      <h3 class="fs-4 fw-bold">Đặt hàng online</h3>
